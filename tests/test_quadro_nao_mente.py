...
CONTAGENS_NO_QUADRO: dict[str, tuple[int, str]] = {
    ...
    "test_m2_conta_pessimista.py": (16, "1.6/4.1 — limite pessimista"),
    ...
    "test_4_0c_laco_maker.py": (63, "4.0(c) — o laço maker"),
    ...
    "test_resumo_da_rodada_maker.py": (55, "4.2 — o leitor da rodada"),
    "test_4_2_rodadas_do_shadow.py": (23, "4.2 — as quatro rodadas"),
}
