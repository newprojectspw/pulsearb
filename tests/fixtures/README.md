...
| `gamma_market_stale_slug_resolution.json` | Caso real: `bitcoin-up-or-down-august-16-2pm-et` resolvendo 200 na janela homônima de 2025 (API_NOTES 12.12b) | **Sintético estrutural** sobre o caso observado. Teste negativo do `validate_window_match`. |
