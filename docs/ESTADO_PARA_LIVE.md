...
| 4.2 | **SHADOW ≥ 2 semanas** com edge líquido *medido* | 🟡 **o relógio COMEÇOU em 2026-09-01 05:51 UTC** (PID 56001), com as duas correções que o tornam mensurável: o motor atravessa o livro (`simulate_taker_buy`) em vez de ler `best_ask`, e o prazo é duplo (3.14). Todo PnL de shadow **anterior** a 31/08 sai enviesado para cima e não conta. Faltam ~14 dias — e o 4.2 exige *edge líquido medido*, que com o taker reprovado em 1.1/1.4 não deve aparecer; o ensaio serve para **medir isso ao vivo**, não para esperar que mude |
