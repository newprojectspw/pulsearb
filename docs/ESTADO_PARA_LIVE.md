...
| 3.13 | SHADOW rodando 24 h sem crash | 🟡 **rodando desde ~2026-08-30 23:30 UTC** (`caffeinate -i python -m pulsearb.live.shadow --duration 24h --curva-de-variancia relatorios/VARIANCIA_23AGO.json`). PID 24507, feeds_saudaveis=True, 1244 tentativas, edge_abaixo_do_threshold (esperado). Falta completar as 24 h e conferir o diário |
